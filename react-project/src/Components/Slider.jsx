...
function SliderComp() {
    const settings = {
      ...
      return (
        <div style={{textALign:"center",padding:"10px 100px",marginLeft:"50px"}}>
        
          <Slider {...settings}>
            <div>
            <div class="product-card">
                <div class="product-image">
                    <img src="https://gnbdevcdn.s3.amazonaws.com/Images/Category/Exoticvegetablesweb.png"
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="https://gnbdevcdn.s3.amazonaws.com/Images/Category/coldcutweb.png" class="product-thumb"
                        alt="" />
                </div>
                <div class="product-info">
                    <a href="#">
                    ...
                    <a href="#"><button class="btnn">View all</button></a>
                </div>
            </div>
            </div>
            <div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="#">
                        <p class="product-short-description">breadsticks crostinni lavache</p>
                    </a>
                    <a href="#">
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="https://gnbdevcdn.s3.amazonaws.com/Images/Category/dailyessentialsweb.png"
                        class="product-thumb" alt="" />
                </div>
                <div class="product-info">
                    <a href="#">
                    ...
                    <a href="#">
                        <p class="product-short-description">breakfast, dairy & bakery</p>
                    </a>
                    <a href="#">
            ...
            <div>
             <div class="product-card">
                <div class="product-image">
                    <img src="https://gnbdevcdn.s3.amazonaws.com/Images/Category/Organicweb.png" class="product-thumb"
                        alt="" />
                </div>
                <div class="product-info">
                    <a href="#">
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="https://gnbdevcdn.s3.amazonaws.com/Images/Category/bespokeweb.png" class="product-thumb"
                        alt="" />
                </div>
                <div class="product-info">
                    <a href="#">
                    ...
                    <a href="#">
                        <p class="product-short-description">celebration with nature basket</p>
                    </a>
                    <a href="#">
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="https://gnbdevcdn.s3.amazonaws.com/Images/Category/fineteasweb.png" class="product-thumb"
                        alt="" />
                </div>
                <div class="product-info">
                    <a href="#">
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="#">
                        <p class="product-short-description">amaranth couscous quinoa</p>
                    </a>
                    <a href="#">
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="#">
                        <p class="product-short-description">milk dark mint chocolates</p>
                    </a>
                    <a href="#">
                        <p class="product-short-description">cakes, brownies & pancakes</p>
                    </a>
                    <a href="#">
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <a href="#">
                        <p class="product-short-description">olive extravirgin olive oils</p>
                    </a>
                    <a href="#"><button class="btnn">View all</button></a>
                </div>
            </div>

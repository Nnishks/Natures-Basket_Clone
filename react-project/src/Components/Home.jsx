...
productContainers.forEach((item, i) => {
  ...
  <div className="heading"><a href="">SHOP BY CATEGORY </a>
      <div className="submenu1">
          <a href="#">
              <div className="opt" id="gift">Gift Hampers
                  <div className="box">
                      <div className="box11" id="img1">
                          ...
                          <img src="https://gnbdevcdn.s3.amazonaws.com/Images/Category/bespokeweb.png"
                           alt="" />
                      </div>
                  </div>
              </div>
          ...
          <a href="#">
              <div className="opt" id="fru">fruits & vegetables
                  <div className="box">
                      <div className="box11" id="img2">
                          ...
                          <img src="https://gnbdevcdn.s3.amazonaws.com/Images/Category/Organicweb.png" 
                          alt="" />
                      </div>
                  </div>
              </div>
          ...
          <a href="#">
              <div className="opt" id="meat">cheese,meat & fruit
                  <div className="box">
                      <div className="box11" id="img3">
                          ...
                          <img src="https://gnbdevcdn.s3.amazonaws.com/Images/Category/coldcutweb.png"
                           alt="" />
                      </div>
                  </div>
              </div>
          ...
          <a href="#">
              <div className="opt" id="deli">delicatessen & cheese
                  <div className="box">
          ...
          <a href="#">
              <div className="opt" id="cui">international cuisine
                  <div className="box">
          ...
          <a href="#">
              <div className="opt" id="hea">health
                  <div className="box">
          ...
          <a href="#">
              <div className="opt" id="ind">indian grocery
                  <div className="box">
          ...
          <a href="#">
              <div className="opt" id="pati">confectionary & patisserie
                  <div className="box">
          ...
          <a href="#">
              <div className="opt" id="sea">meat,seafood and eggs
                  <div className="box">
          ...
          <a href="#">
              <div className="opt" id="sna">snack bar
                  <div className="box">
                      <div className="box11" id="img10">
                          ...
                          <img src="https://gnbdevcdn.s3.amazonaws.com/Images/Category/Readytoeatweb.png"
                           alt="" />
                      </div>
                  </div>
              </div>
          ...
          <a href="#">
              <div className="opt" id="bev">snacks & beverages
                  <div className="box">
                      <div className="box11" id="img11">
                          ...
                          <img src="https://gnbdevcdn.s3.amazonaws.com/Images/Category/fineteasweb.png" 
                          alt="" />
                      </div>
                  </div>
              </div>
          ...
          <a href="#">
              <div className="opt" id="pack">packing material
                  <div className="box">
                      <div className="box11" id="img12">
                          ...
                          <img src="https://www.naturesbasket.co.in/Images/NaturesBasketGifting.jpeg?v=7"
                           alt="" />
                      </div>
                  </div>
              </div>
  ...
  <div className="heading"><a >MY ORDERS</a></div>
  <div className="heading"><a href="raj.html">GIFTING</a></div>
  <div className="heading"><a >REWARDS</a></div>
  <div className="heading" ><a href="blogm.html">BLOG</a>
  ...
  <div className="heading"><a href="#">OFFERS</a></div>
  <div className="heading"><a href="#">CONNOISSEUR'S SELECTION</a></div>
  <div className="heading" id="moveleft"><a href="#">BOOK STORE VISIT</a></div>
</div>  

<div id="poster1">
        <img src="//gnbdevcdn.s3-ap-southeast-1.amazonaws.com/Marketing/d8cc09f5-5d68-4853-ae9a-233ceabe3acd.jpg"
            alt="" />
    </div>
  <div id="poster2">
    ...
    <div id="poster3">
        ...
        <div>
            <img src="https://www.naturesbasket.co.in/Images/Gluten-free-web%20box%20banner.png?v=15"
             alt="" />
        </div>
    </div>
    <br></br>
    ...
    {/* <ChevronLeftIcon color="red.600"/> */}
     <SliderComp /> 
    <div id="poster4">
        <img src="https://www.naturesbasket.co.in/Images/homepageblogbanner/NB_paneerBlog_banner.jpg" alt="" />
    </div>
...
{trenddata.map((el,i)=>{
  return (
       <div className="trendbox">
        ...
        <img className="cartthg" src="https://www.naturesbasket.co.in/Images/CartAddBtn.PNG"
         alt=""></img>
       </div>
    ...
    <div id="event">
        ...
        <div className="evenbox">
            <img src="https://www.naturesbasket.co.in/Images/PhotoGallery/2-ph150419.jpeg" alt="" />
        </div>
        <div className="evenbox">
            <img src="https://d1z88p83zuviay.cloudfront.net/Images/PhotoGallery/Laffaire_Event_Thumbnail.png" alt="" />
        </div>
    </div>
    <h1>SHOP BY WORLD BRANDS</h1>
    <div id="brand">
        <div className="brandimg">
            <img src="https://d1z88p83zuviay.cloudfront.net/Images/davidoff-cafe.jpg" alt="" />
        </div>
        <div className="brandimg">
    ...
    <div id="info">
        ...
        <p>Nature’s Basket is a grocery store operating in Mumbai, Bangalore and Pune with deliveries to all cities
            across India including Hyderabad, Delhi, Kolkata, Chennai, Surat and more. We offer a wide range of food
            products for all your everyday needs and even offer grocery home delivery as well as a grocery shop
            online for you to purchase from. Our online grocery store has fresh fruits and vegetables, fresh and
            frozen meats and seafood, a wide range of breads and other packaged bakery products as well as a range
            of fresh cheeses from around the world. We even have a range of every staple and international cuisine
            product to meet your needs along with organic products for fresh and packaged food items. With our
            offerings, we have the best online food shop & online grocery shopping platform available for all your
            grocery products as well as physical grocery stores in select cities.</p>
        <h2>Best Online Grocery Supermarket India</h2>
        <p>With stores in Mumbai, Pune and Bangalore and online delivery services, you can now have all your grocery
            supermarket shopping done online. We have a wide range of grocery products to offer at our stores for
            you to buy groceries from a channel convenient to you. Choose from fresh produce to packaged goods, buy
            groceries online and get them delivered straight to your doorstep, thus making it a convenient and quick
            process. You can pay for the shopping using credit cards, cash, coupons or online banking facility. We
            are sure to have all the grocery products for your daily dietary needs from regular local Indian brands
            and products to exotic and international imported ones.</p>
        <h2>Online Grocery Supermarket Shopping India</h2>
        <p>With our wide range of groceries available, Nature’s Basket is a large online supermarket and grocery
            store for all your everyday food needs. We offer you the best quality grocery products which you can buy
            online and have them delivered to you conveniently. We have our grocery stores in Mumbai, Pune and
            Bangalore where you can buy groceries and food items. We also have the best online grocery store to shop
            for fruits and vegetables, meats and seafood, breads and other bakery items as well as cheese and dairy.
            Order groceries online from the best quality grocery store at best prices.</p>
        <p>Find a variety of Best Christmas gifts such as delightful Cakes, Chocolates, Cookies, Turkey, Stollen,
            Gourmet Gift Baskets, Sweets & Lots More Here</p>
    </div>
